var Controller = "ShippingAgent", CommonController = "Common";//// Controller Name Declare
    ...
    if (result != undefined) {
        $(result).each(function (index, element) {
            content += '<tr>' +
                ...
                '<td class="contNo">' + element.ContactNo + '</td>' +
                '<td class="email">' + element.Email + '</td>' +
                '<td class="description">' + element.ContactPerson + '</td>' +
...
$(document).off('click', '.edit').on('click', '.edit', function () {
    ...
    $('#txtContactPerson').val(description);
    $('#txtNotes').val(note);
    //$.uniform.update(
