                                ...
                                '<tr>' +
                                    '<td width="60%" style="font-size:12px;">' +
                                        '<table width="95%" border="0" cellspacing="0" cellpadding="0">' +
                                            '<tbody>' +
                                                '<tr>' +
                                                    '<td width="19%"><img src="../App_Theme/assets/images/fb-logo.png" width="70" height="70"></td>' +
                                                    '<td width="81%" valign="top" style="padding-left: 10px;">' +
                                                        '<span class="style1" style="font-size: 15px;font-weight: bold;"></span><br>' +
                                                         '<br>  <span style="font-size: 20px;font-weight: bold;">FB Sales</span><br>' +
                                            ...
                                            ' </table>' +
     '</td>' +
         '<td align="right" valign="middle" style="padding-right: 10px;"> <span class="style1">Order Invoice<br></span><table width="80%" border="0" cellspacing="0" cellpadding="2" style="font-size:12px;"> <tbody><tr> <td><strong>Invoice No </strong></td> <td align="right"><strong>' + mdata[0].InvoiceNo + '</strong></td> </tr> ' +
         '<tr> <td>Date</td> <td align="right">' + mdata[0].SaleDate + '</td> </tr> <tr> <td>Order Place </td> <td align="right">' + mdata[0].SaleOutlateName + '</td> </tr>' +
         '<tr> <td>Reference No</td> <td align="right">' + mdata[0].ReferenceNo + '</td>  </tr>' +
         '<tr> <td>Sales Person</td> <td align="right">' + mdata[0].SalesPersonName + '</td> </tr> </tbody></table></td>' +
    '</tr>' +
    '</tbody>' +
    '</table>' +
    '</td>' +
